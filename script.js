...
function showModal() {
  // JS 03: This function just removes the "hidden" class from the two elements (reference stored by lines 3 and 4 above), which makes them visisble
...
for (let i = 0; i < btnsOpeneModal.length; i++) {
  // JS 01: At this point, loop through the contents of the btnsOpeneModal array
